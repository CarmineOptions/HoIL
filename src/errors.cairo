mod Errors {
    const CALL_OPTIONS_UNAVAILABLE: felt252 =
        'No call opt. for hedge'; // Option AMM doesnot have call options for requested hedge
    const PUT_OPTIONS_UNAVAILABLE: felt252 =
        'No put opt. for hedge'; // Option AMM doesnot have put options for requested hedge
    ...
    const LOWER_BOUND_TOO_HIGH: felt252 = 'Lower bound too high';
    const UPPER_BOUND_TOO_LOW: felt252 = 'Upper bound too low';
}
